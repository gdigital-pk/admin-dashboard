...
export default function UsersPage() {
  ...
  return (
    <>
      ...
      <EditUserModal user={editUser} open={modalOpen} onClose={() => { setModalOpen(false); setEditUser(null); }}
        onSaved={() => { flash("User updated.", true); fetchUsers(); }} />
      <UpdatePassword user={passwordUser} open={passwordOpen} onClose={() => { setPasswordOpen(false); setPasswordUser(null); }}
        onUpdated={() => {
